...
PACKAGES = "gstreamer1.0-plugins-bad-waylandsink gstreamer1.0-plugins-bad"
PROVIDES = "gstreamer1.0-plugins-bad-waylandsink gstreamer1.0-plugins-bad"
...
DEPENDS += "orc gstreamer1.0-plugins-bad-oss"

#PROVIDES_remove = "gstreamer1.0-plugins-bad"
