...
SRC_URI += "http://ports.ubuntu.com/ubuntu-ports/pool/universe/p/python3.8/libpython3.8-testsuite_3.8.10-0ubuntu1~20.04.9_all.deb;name=libpython3.8-testsuite"
SRC_URI[libpython3.8-testsuite.md5sum] = "2deaa8951cab08c144245c491ddecc1b"
...
SRC_URI += "http://ports.ubuntu.com/ubuntu-ports/pool/universe/p/python3.8/python3.8-full_3.8.10-0ubuntu1~20.04.9_arm64.deb;name=python3.8-full"
SRC_URI[python3.8-full.md5sum] = "65a58240d2ff9ba691bb63cbfa66096a"
