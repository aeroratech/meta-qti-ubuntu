...
do_enable_adb_tcp() {
    echo "persist.adb.tcp.port=2445" >> ${IMAGE_ROOTFS}/build.prop
}
...
ROOTFS_POSTINSTALL_COMMAND += "do_post_install; do_deb; do_enable_adb_root; do_enable_adb_tcp; "
...
# Install packages for aeroratech
CORE_IMAGE_BASE_INSTALL += " \
